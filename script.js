...
box1.addEventListener('mouseenter',()=>{
    ...
    box1.style.boxShadow='5px 5px 20px #059bffff';
...
box2.addEventListener('mouseenter',()=>{
    ...
    box2.style.boxShadow='-5px 5px 20px #ff3305ff';
...
box3.addEventListener('mouseenter',()=>{
    ...
    box3.style.boxShadow='5px -5px 20px #05ff16ff';
...
box4.addEventListener('mouseenter',()=>{
    ...
    box4.style.cursor='resize';
    box4.textContent="Box 4";
    box4.style.boxShadow='-5px -5px 20px #d5ff04ff';
